...
class PortsTable extends Component
{
    ...
    public function render()
    {
        ...
        if ($searchTrimmed !== '') {
            $ports = $this->fetchAllAndFilterCaseInsensitive(
                fn (array $params) => $this->getMaestrosApiService()->getPorts($params),
                $searchTrimmed,
                $this->perPage,
                $this->getPage(),
                $this->sortField,
            ...
            return view('livewire.maestros.ports-table', [
                'ports' => $ports
            ]);
        }
        ...
        $response = $this->getMaestrosApiService()->getPorts($params);
