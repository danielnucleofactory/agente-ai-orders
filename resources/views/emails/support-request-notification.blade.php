...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f7f7f7; padding: 30px; border-radius: 10px;">
        <h1 style="color: #565AFF; margin-bottom: 20px;">Nueva Solicitud de Soporte</h1>
        ...
        <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #565AFF;">
            <h2 style="color: #565AFF; margin-top: 0;">Detalles de la solicitud:</h2>
            <p><strong>ID de Solicitud:</strong> #{{ $supportRequest->id }}</p>
            <p><strong>Usuario:</strong> {{ $user->name }}</p>
            <p><strong>Correo del Usuario:</strong> {{ $user->email }}</p>
        ...
        <p style="margin-top: 30px; color: #666; font-size: 14px;">
            Saludos,<br>
            Sistema de Notificaciones - Next
        </p>
    </div>
</body>
</html>
