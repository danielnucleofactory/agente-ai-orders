...
>
    <button
        ...
        @if($filterCount > 0)
            <span class="absolute flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-[#1AAD8A] rounded-full -right-2 -top-2">
                {{ $filterCount }}
            </span>
        @endif
    </button>
        ...
        <div class="space-y-4">
            ...
            @if(count($currencies) > 0)
                <div>
                    ...
                    <select id="currency-filter" wire:model.live="selectedCurrency" class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:border-[#1AAD8A] focus:outline-none focus:ring-[#1AAD8A] sm:text-sm">
            ...
            @if(count($incoterms) > 0)
                <div>
                    ...
                    <select id="incoterm-filter" wire:model.live="selectedIncoterm" class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:border-[#1AAD8A] focus:outline-none focus:ring-[#1AAD8A] sm:text-sm">
            ...
            @if(count($plannedHubs) > 0)
                <div>
                    ...
                    <select id="planned-hub-filter" wire:model.live="selectedPlannedHub" class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:border-[#1AAD8A] focus:outline-none focus:ring-[#1AAD8A] sm:text-sm">
            ...
            @if(count($actualHubs) > 0)
                <div>
                    ...
                    <select id="actual-hub-filter" wire:model.live="selectedActualHub" class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:border-[#1AAD8A] focus:outline-none focus:ring-[#1AAD8A] sm:text-sm">
            ...
            @if(count($materialTypes) > 0)
                <div>
                    ...
                    <select id="material-type-filter" wire:model.live="selectedMaterialType" class="block w-full py-2 pl-3 pr-10 mt-1 text-base border-gray-300 rounded-md focus:border-[#1AAD8A] focus:outline-none focus:ring-[#1AAD8A] sm:text-sm">
            ...
            <div class="flex justify-between pt-3">
                <button
                    ...
                    type="button"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#1AAD8A] border border-transparent rounded-md shadow-sm hover:bg-[#127A62] focus:outline-none focus:ring-2 focus:ring-[#1AAD8A] focus:ring-offset-2"
                >
                    Aplicar filtros
                </button>
                ...
                <button
                    ...
                    type="button"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#1AAD8A] focus:ring-offset-2"
                >
                    Limpiar filtros
                </button>
            </div>
