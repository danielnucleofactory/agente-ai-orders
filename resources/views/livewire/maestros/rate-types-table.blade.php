<div>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                            No se encontraron tipos de tarifa.
                        </td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="text-sm text-gray-700">
            Mostrando {{ $rateTypes->firstItem() ?? 0 }} a {{ $rateTypes->lastItem() ?? 0 }} de {{ $rateTypes->total() }} resultados
        </div>
        <div class="flex items-center space-x-1">
            @if ($rateTypes->onFirstPage())
            ...
            @foreach ($rateTypes->getUrlRange(max(1, $rateTypes->currentPage() - 3), min($rateTypes->lastPage(), $rateTypes->currentPage() + 3)) as $page => $url)
                @if ($page == $rateTypes->currentPage())
