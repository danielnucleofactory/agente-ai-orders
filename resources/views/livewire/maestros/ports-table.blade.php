<div>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="text-sm text-gray-700">
            Mostrando {{ $ports->firstItem() ?? 0 }} a {{ $ports->lastItem() ?? 0 }} de {{ $ports->total() }} resultados
        </div>
        <div class="flex items-center space-x-1">
            ...
            @foreach ($ports->getUrlRange(max(1, $ports->currentPage() - 3), min($ports->lastPage(), $ports->currentPage() + 3)) as $page => $url)
