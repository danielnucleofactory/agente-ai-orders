<div>
    ...
    <div class="overflow-x-auto rounded-t-xl">
        <table class="min-w-full divide-y divide-[#D4F5ED]">
            ...
            <tbody class="divide-y divide-[#D4F5ED] bg-white">
                @forelse ($transportTypes as $item)
                    <tr>
                        <td class="px-6 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                            No se encontraron tipos de transporte.
                        </td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="text-sm text-gray-700">
            Mostrando {{ $transportTypes->firstItem() ?? 0 }} a {{ $transportTypes->lastItem() ?? 0 }} de {{ $transportTypes->total() }} resultados
        </div>
        <div class="flex items-center space-x-1">
            @if ($transportTypes->onFirstPage())
            ...
            @foreach ($transportTypes->getUrlRange(max(1, $transportTypes->currentPage() - 3), min($transportTypes->lastPage(), $transportTypes->currentPage() + 3)) as $page => $url)
                @if ($page == $transportTypes->currentPage())
            ...
            @if ($transportTypes->hasMorePages())
