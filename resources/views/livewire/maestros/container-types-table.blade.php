<div>
    ...
    <div class="overflow-x-auto rounded-t-xl">
        <table class="min-w-full divide-y divide-[#D4F5ED]">
            ...
            <tbody class="divide-y divide-[#D4F5ED] bg-white">
                @forelse ($containerTypes as $item)
                    <tr>
                        <td class="px-6 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                            No se encontraron tipos de contenedor.
                        </td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="text-sm text-gray-700">
            Mostrando {{ $containerTypes->firstItem() ?? 0 }} a {{ $containerTypes->lastItem() ?? 0 }} de {{ $containerTypes->total() }} resultados
        </div>
        <div class="flex items-center space-x-1">
            @if ($containerTypes->onFirstPage())
            ...
            @foreach ($containerTypes->getUrlRange(max(1, $containerTypes->currentPage() - 3), min($containerTypes->lastPage(), $containerTypes->currentPage() + 3)) as $page => $url)
                @if ($page == $containerTypes->currentPage())
            ...
            @if ($containerTypes->hasMorePages())
