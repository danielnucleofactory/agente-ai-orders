<div>
    ...
    <div class="overflow-x-auto rounded-t-xl">
        <table class="min-w-full divide-y divide-[#D4F5ED]">
            ...
            <tbody class="divide-y divide-[#D4F5ED] bg-white">
                @forelse ($serviceProviders as $item)
                    <tr>
                        <td class="px-6 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                            No se encontraron proveedores de servicio.
                        </td>
                    </tr>
                @endforelse
            </tbody>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="text-sm text-gray-700">
            Mostrando {{ $serviceProviders->firstItem() ?? 0 }} a {{ $serviceProviders->lastItem() ?? 0 }} de {{ $serviceProviders->total() }} resultados
        </div>
        <div class="flex items-center space-x-1">
            ...
            @foreach ($serviceProviders->getUrlRange(max(1, $serviceProviders->currentPage() - 3), min($serviceProviders->lastPage(), $serviceProviders->currentPage() + 3)) as $page => $url)
