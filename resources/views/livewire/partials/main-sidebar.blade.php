        ...
        <ul class="space-y-2 w-full">
            ...
            <li>
                <x-sidebar-dropdown active="{{ request()->is('support') || request()->is('support/*') }}" route="{{ route('support.index') }}">
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18"
                            ...
                            <path
                                ...
                                class="{{ request()->is('support') || request()->is('support/*') ? 'fill-[#1AAD8A]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500" />
                        </svg>
                    </x-slot:icon>
                    ...
                    <ul
                        class="{{ request()->is('support') || request()->is('support/*') ? 'border-[#1AAD8A]' : 'border-gray-200' }} ml-[0.625rem] mt-2 flex flex-col space-y-1 border-l-2 pl-2.5">
                        <li>
