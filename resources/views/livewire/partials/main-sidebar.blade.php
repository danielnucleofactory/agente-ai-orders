        ...
        <ul class="space-y-2 w-full">
                ...
                <x-sidebar-link href="{{ route('dashboard') }}"
                    ...
                    <div class="flex justify-center items-center w-5 h-5" onclick="document.querySelector('.main-sidebar').classList.toggle('sidebar-expanded'); localStorage.setItem('sidebarExpanded', document.querySelector('.main-sidebar').classList.contains('sidebar-expanded'));">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 18 17"
                            fill="none">
                            <path
                                class="{{ request()->routeIs('dashboard') ? 'fill-[#1AAD8A]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500"
                    ...
                    <div
                        class="link-text {{ request()->routeIs('dashboard') ? 'text-[#1AAD8A]' : 'group-hover:text-black' }} transition-colors duration-500">
                        <span>Inicio</span>
                    </div>
                </x-sidebar-link>
            </li>
            ...
            <li>
                ...
                >
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="18" viewBox="0 0 16 20 "
                            ...
                            <path
                                ...
                                class="{{ request()->is('purchase-orders') || request()->is('purchase-orders/*') ? 'fill-[#1AAD8A]' : 'group-hover:fill-black fill-[#898989]' }} transition-colors duration-500" />
                            <path
                    ...
                    <ul
                        class="{{ request()->is('purchase-orders') || request()->is('purchase-orders/*') ? 'border-[#1AAD8A]' : 'border-gray-200' }} ml-[0.625rem] mt-2 flex flex-col space-y-1 border-l-2 pl-2.5">
            ...
            <li>
                <x-sidebar-dropdown active="{{ request()->is('support') || request()->is('support/*') }}" route="{{ route('support.contact') }}">
                    ...
                    <ul
                        class="{{ request()->is('support') || request()->is('support/*') ? 'border-green-60' : 'border-gray-200' }} ml-[0.625rem] mt-2 flex flex-col space-y-1 border-l-2 pl-2.5">
                        <li>
